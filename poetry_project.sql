...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 02, 2020 at 06:51 AM
...
(22, 4, '2020-06-02', 'TANGISAN AIR MATA BUNDA', '<p xss=removed>“Dalam Senyum kau sembunyikan letihmu<br>Derita siang dan malam menimpamu<br>tak sedetik pun menghentikan langkahmu<br>Untuk bisa Memberi harapan baru bagiku</p>\r\n<p xss=removed>Bukan setumpuk Emas yang kau harapkan dalam kesuksesanku<br>bukan gulungan uang yang kau minta dalam keberhasilanku<br>bukan juga sebatang perunggu dalam kemenanganku<br>tapi keinginan hatimu membahagiakan aku</p>\r\n<p xss=removed>Dan yang selalu kau berkata padaku<br>Aku menyayangimu sekarang dan waktu aku tak lagi bersama mu<br>aku menyayangi mu anak ku dengan ketulusan hatiku”</p>');
...
--
ALTER TABLE `post`
  MODIFY `post_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
